var TwitterText = (function () { 
    ...
    my.auto_link_usernames_or_lists = function(text, opt, func){
      ...
      var r = text.replace(regexes['auto_link_usernames_or_lists'], function(str, p1, p2, p3, p4, offset, s){
        ...
        if(p4 && !options['suppress_lists']){
          ...
          return p1 + p2 + "<span class=\"vcard list\"><a class=\"" + options['url_class'] + " " + options['list_class'] + "\" href=\"" + options['list_url_base'] + list + "\"" + extra_html + "><span class=\"fn listname\">" + t + "</span></a></span>";
        }else {
          // # this is a screen name
          var t = p3;
          
          if(func){ t = func(text); }
          return p1 + p2 + "<span class=\"vcard atmention\"><a class=\"" + options['url_class'] + " " + options['username_class'] + "\" href=\"" + options['username_url_base'] + t + "\"" + extra_html + "><span class=\"fn nickname\">" + t + "</span></a></span>";       
        }
    ...
    my.auto_link_urls_custom = function(text, opt){
      ...
      var r = text.replace(regexes['valid_url'], function(str, all, before, url, protocol, p4, offset, s){
        ...
        return before + "<a href=\"" + full_url + "\"" + html_attrs + " target=\_blank\" title=\""+full_url+"\">" + url + "</a>";
      });
    ...
    my.auto_link_hashtags = function(text, opt, func){
      ...
      var extra_html = "target=\"_blank\" rel=\"tag\"";
      if(!options['suppress_no_follow']){
      ...
      var r = text.replace(regexes['auto_link_hashtags'], function(str, before, hash, text, offset, s){
        ...
        return before + hash + "<span class=\"tag\"><a href=\"" + options['hashtag_url_base'] + text + "\" title=\"#" + text + "\" class=\"" + options['url_class'] + " " + options['hashtag_class'] + "\"" + extra_html + ">" + text +"</a></span>";
      });
